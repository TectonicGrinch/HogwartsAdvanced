...
bot.db.set(message.author.id, { health: 100, balance: 1000, inv: [], job: {}, daily: 0, location: 'london', bloodType: 'Half-Blood', race: 'Human', specialAttribute: 'none', backstory: 'none', frogCards: [] })
