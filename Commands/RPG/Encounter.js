...
module.exports.run = async (bot, message, args) => {
    ...
    let locationEncounter;
        try {
            locationEncounter = require(`../../json/encounters/locations/${locationUser}.json`)

            let encounter = locationEncounter.rpgEncounter[Math.floor(Math.random() * locationEncounter.rpgEncounter.length)]
